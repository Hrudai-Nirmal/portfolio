...
- Replaced the desktop rail's embedded menu control with a decorative AUX THRUST module. Across the first 240px of scroll, the rail dips 18px before slinging above the viewport while the detached compact menu slings into the top-right; the scrubbed timeline retraces the same frames in reverse. The menu remains fixed after the handoff, while compact layouts keep their always-visible menu behavior.
