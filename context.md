...
- Reworked all four SVG navigation keys as tactile retro console controls: chamfered inner faces, numbered `NAV 01`–`NAV 04` hardware labels, screw heads, dashed service seams, and retained blue-to-yellow hover lamps. Their links and accessible labels are unchanged.
