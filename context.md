...
- Replaced the approximate card-based rail with the selected Mission Control Rail artwork itself, mapped semantic navigation/chat/menu hit areas onto its controls, and made the desktop rail persistent instead of fading or collapsing on scroll.
