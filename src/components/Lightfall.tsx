...
/**
 * WebGL light-streak background generated from the React Bits Lightfall registry
 * component. The named color props preserve the exact supplied integration API.
 */
...
/** Renders an interactive OGL light-streak canvas. */
const Lightfall: React.FC<LightfallProps> = ({
  ...
  useEffect(() => {
    ...
    const namedColors = [color1, color2, color3].filter(
