const contactLinks = [
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/hrudianirmal",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="28"
  ...
  {
    label: "Email",
    href: "mailto:hrudainirmal5@gmail.com",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="28"
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        strokeLinejoin="round"
      >
        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.12.91.33 1.8.62 2.66a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.42-1.19a2 2 0 0 1 2.11-.45c.86.29 1.75.5 2.66.62A2 2 0 0 1 22 16.92z" />
      </svg>
    ),
  },
];
    ...
    <section id="contact" className="snap-section px-6 bg-transparent">
      <div className="max-w-4xl mx-auto w-full text-center">
        <div className="mb-12">
          ...
          <div className="w-16 h-1 bg-accent rounded mt-4 mx-auto" />
        </div>

        <p className="text-text-secondary text-lg leading-relaxed max-w-2xl mx-auto mb-14">
        ...
        <div className="grid grid-cols-3 md:grid-cols-5 gap-6 max-w-xl md:max-w-2xl mx-auto">
