...
/**
 * SVG outline text animation generated from the React Bits StrokeText registry
 * component and adapted so scroll playback is reversible and directly scrubbed.
 */
...
/** Renders SVG text whose stroke and fill can be driven by scroll progress. */
const StrokeText = ({
  text = DEFAULT_TEXT,
  strokeColor = '#A78BFA',
  fillColor = '#F8FAFC',
